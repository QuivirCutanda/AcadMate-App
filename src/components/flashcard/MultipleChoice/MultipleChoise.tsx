  ...
  return (
    <View className="bg-background-light flex-1">
      ...
      <Header
        ...
        title={
          studyType === "MultipleChoiceTimer"
            ? "Multiple Choice (Timer)"
            : "Multiple Choice"
        }
      />
      {showDurationModal == true && StudyType == "MultipleChoiceTimer" ? (
        <Modal onClose={() => false} visible={showDurationModal} Width="96">
          <TimerDuration
            durationTime={(time) => {
              setDuration(time);
              setShowDurationModal(false);
        ...
        <View className="bg-background-light p-4 flex-1 justify-center items-center">
          {studyType === "MultipleChoiceTimer" && startTimer == true && (
